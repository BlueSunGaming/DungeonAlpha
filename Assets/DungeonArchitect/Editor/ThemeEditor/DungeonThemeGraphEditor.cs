...
namespace DungeonArchitect.Editors
{
    ...
    public class DungeonThemeGraphEditor : GraphEditor
    {
        ...
        public override GraphNode CreateNode(Vector2 screenCoord, UnityEngine.Object hostAsset, System.Type nodeType)
        {
            var node = base.CreateNode(screenCoord, hostAsset, nodeType);
