...
namespace LogicSpawn.RPGMaker.Core
{
    ...
    public class GivePlayerCraftableItemNode : BooleanNode
    {
        public override string Name
        {
            get { return "Give Player Craftable Item"; }
        }
        ...
        protected override bool Eval(NodeChain nodeChain)
        {
            ...
            if (item != null)
            {
                ...
                {
                    itemsToAdd.Add(Rm_RPGHandler.Instance.Repositories.CraftableItems.Get(itemId));
                }
